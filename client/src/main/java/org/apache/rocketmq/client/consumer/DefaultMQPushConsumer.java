...
public class DefaultMQPushConsumer extends ClientConfig implements MQPushConsumer {
     ...
     */
    //并发消息消费时处理队列最大跨度,默认2000 表示如果消息处理队列中偏移量最大的消息与偏移量最小的消息跨度超过2000则延迟50毫秒后再拉取消息
     ...
     */
    //推模式下拉取任务间隔时间,默认拉取一次消息后继续拉取 间隔时间为0
