...
public class DefaultMQProducer extends ClientConfig implements MQProducer {
    ...
    /**
     * 生产这所在组，消息服务器在回查状态时会随机选择该组中任何一个生产者发起的事物回查请求
     ...
     *异步发送消息，sendcallback擦数是消息发送成功后的回调方法
     ...
     *消息发送，指定消息选择算法，覆盖消息生产这默认的消息队列负载
     * @param msg Message to send.
